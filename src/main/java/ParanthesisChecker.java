...
class ParanthesisChecker {
    ...
    static int sumOfCurlyBrackets;
    static int sumOfSquareBrackets;
    static int sumOfRoundBrackets;
    static boolean stop;

    static String areAllParanthesesClosed(List<Character> parantheses) {
        calculateSumOfBracketValuesByParanthesisType(parantheses);
        return stop ?
                "trying to open paranthesis with closing bracket"
                :
                Boolean.toString(sumOfCurlyBrackets == 0
                        && sumOfSquareBrackets == 0
                        && sumOfRoundBrackets == 0);
    }
    ...
    private static void stopCheckingIfPositive(int sumOfTheseBrackets) {
        if (sumOfTheseBrackets > 0) {
            stop = true;
        }
    }
...
//
//    public ParanthesisChecker(List<Character> parantheses) throws IllegalClosingBracketException {
//        calculateSumOfBracketValuesByParanthesisType(parantheses);
//    }
//
...
//
//    public ParanthesisChecker(List<Character> parantheses) {
//        calculateSumOfBracketValuesByParanthesisType(parantheses);
//    }
//
